          ...
          <div className="bg-[hsl(var(--card))] rounded-2xl p-8 md:p-12 border border-[hsl(var(--border))] shadow-sm">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="p-4 bg-[hsl(var(--muted))] rounded-xl border border-[hsl(var(--border))]">
                ...
                <p className="text-sm text-[hsl(var(--muted-foreground))]">Feature placeholder 1</p>
              </div>
              <div className="p-4 bg-[hsl(var(--muted))] rounded-xl border border-[hsl(var(--border))]">
                <h3 className="font-semibold text-[hsl(var(--card-foreground))] mb-2">{t("Home.about.whatsNext.comingSoon")}</h3>
                <p className="text-sm text-[hsl(var(--muted-foreground))]">Feature placeholder 2</p>
              </div>
              <div className="p-4 bg-[hsl(var(--muted))] rounded-xl border border-[hsl(var(--border))]">
                <h3 className="font-semibold text-[hsl(var(--card-foreground))] mb-2">{t("Home.about.whatsNext.comingSoon")}</h3>
                <p className="text-sm text-[hsl(var(--muted-foreground))]">Feature placeholder 3</p>
              </div>
              <div className="p-4 bg-[hsl(var(--muted))] rounded-xl border border-[hsl(var(--border))]">
                <h3 className="font-semibold text-[hsl(var(--card-foreground))] mb-2">{t("Home.about.whatsNext.comingSoon")}</h3>
                <p className="text-sm text-[hsl(var(--muted-foreground))]">Feature placeholder 4</p>
              </div>
            </div>
          </div>
        </div>
